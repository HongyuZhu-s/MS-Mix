...
class TFN():
    def __init__(self, args):
        self.args = args
        self.criterion = nn.L1Loss() if args.train_mode == 'regression' else nn.CrossEntropyLoss(reduction='none')
        self.criterion1 = nn.MSELoss(reduction='none') if args.train_mode == 'regression' else nn.CrossEntropyLoss(reduction='none')
