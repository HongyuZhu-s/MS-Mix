...
class TFN(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.text_hidden, self.audio_hidden, self.video_hidden = args.hidden_dims   # 128, 32, 128
        self.output_dim = args.num_classes if args.train_mode == "classification" else 1

        self.text_out= args.text_out     # 32
        ...
        # input_dims = {'audio': 33,  # 音频特征维度   mosei 17;  mosi 33;  sims 33
        #               'text': 257,  # 文本特征维度    mosei 129; mosi 33;  sims 257
        #               'vision': 129}  # 视觉特征维度 mosei 129; mosi 129; sims 129
        #
    ...
    def forward(self, text_x, audio_x, video_x, y):
        '''
        Args:
