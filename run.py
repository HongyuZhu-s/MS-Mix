...
def MMSA_run(
    ...
    model_save_dir: str = str(Path("D://MMSA") / "saved_models"),
    res_save_dir: str = str(Path("D://MMSA") / "results"),
    log_dir: str = str(Path("D://MMSA") / "logs"),
):
